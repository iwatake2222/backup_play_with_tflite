...
#ifdef USE_EDGETPU
#define USE_EDGETPU_DELEGATE
#define MODEL_FILENAME RESOURCE"/inception_v3_quant_edgetpu.tflite"
//#define MODEL_FILENAME RESOURCE"/inception_v3_quant.tflite"
#else
#define MODEL_FILENAME RESOURCE"/inception_v3_quant.tflite"
//#define MODEL_FILENAME RESOURCE"/mobilenet_v2_1.0_224.tflite"
#endif
...
int main()
{
	...
	while (1) {
		...
		extractTensorAsFloatVector(interpreter.get(), interpreter->outputs()[0], outputScoreList);
